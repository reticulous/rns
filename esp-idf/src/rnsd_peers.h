 ...
 *  are deliberately not tracked". Same lock-free, advisory-off-task read as
 *  rnsdIfaceWalk, which is public (rnsd.h) because callers outside this
 *  straddle compose records from it. */
